...
#define INVERT_X_DIR false  //false=白色,黑色,true=黄色
#define INVERT_Y_DIR true
#define INVERT_Z_DIR true  //true=黑色 false=白色,黄色
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {605,605,1160,1040}//18472{463,482,18462,1460} //黑色{526.5,491,18280,480}//黄色{337,314,11700,480}//11700//Y292//640{80,80,400,96}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {40, 40,10, 80} //{300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {300,300,50,100}//{3000,3000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

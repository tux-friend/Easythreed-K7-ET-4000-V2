...
//	current_position[X_AXIS] = st_get_position(X_AXIS)/axis_steps_per_unit[X_AXIS];
//	current_position[X_AXIS] = st_get_position(Y_AXIS)/axis_steps_per_unit[Y_AXIS];
//	current_position[X_AXIS] = st_get_position(Z_AXIS)/axis_steps_per_unit[Z_AXIS];
}

FORCE_INLINE void plan_discard_all_block() { 
